    ...
    >
        <Wrapper className="h-[60px] flex justify-between items-center">
            ...
            <div className="flex items-center gap-2 text-black">
                ...
                {/* icon start */}
                {/* <div className="w-8 md:w-12 h-8 rounded-full flex justify-center items-center 
                ...
                {/* Mobile icon start */}
                <div className="w-8 md:w-12 h-8 rounded-full flex md:hidden justify-center items-center 
